...
import flotsam from '../../client_src/flotsam';

//no simple way of subclassing Arrays. Alas, ES6 class notation!

//flotsam is used to efficiently serialize arrays ( or in this case vectors ) into unique strings, 
//this is useful for tilegrid maps, as each tile's vector can be seralized into a unique key
